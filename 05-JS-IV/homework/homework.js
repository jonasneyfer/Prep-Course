...
function invocarMetodo (objeto, metodo) {
  // "metodo" es una cadena que contiene el nombre de un método (funcion) en el 
  // objeto
  // Invoca ese método
...
function eliminarPropiedad (objeto, unaPropiedad) {
  // Elimina la propiedad de objeto cuyo nombre está pasado por el parametro 
  // unaPropiedad
...
function verificarPassword (usuario, password) {
  // Comprueba si la "password" enviada coincide con la propiedad "password" del 
  // objeto "usuario"
...
function sumarLikesDeUsuario (usuario) {
  ...
  for (i = 0;i < usuario.posts.length; i++){
     sumaT = sumaT + usuario.posts[i].likes 
